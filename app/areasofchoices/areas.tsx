...
import ModeofTravelConfirm from "./modeoftravelconfirm";

export default function Areas({ customer }: { customer: any }) {
  const [tasks] = useState([
    { id: "1", title: "Mode of Travel", icon: "car", color: "#38bdf8",path:"areasofchoices/modeoftravelconfirm" },
    { id: "2", title: "Hotel Accommodation", icon: "home", color: "#f97316" },
    { id: "3", title: "Food Cuisine", icon: "food", color: "#22c55e" },
          ...
          {tasks.map((task) => (
            ...
            >
              <View style={[styles.itemCard, { borderLeftColor: task.color }]}>
                ...
                />
                <ModeofTravelConfirm path={task.path}/>
              </View>
            </TouchableOpacity>
          ))}
        </List.Accordion>
