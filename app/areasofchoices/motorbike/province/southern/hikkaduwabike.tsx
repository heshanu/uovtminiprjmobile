...
const INITIAL_DATA:BikeData[] = [
  {
    ...
    location: "Hikkaduwa",
    rating: "4.8",
    image: require("../../../../../assets/images/travelModes/motorbike/hikka/bike1.jpg"),
    path: "vfg",
    count: 1,
    priceperhour:50
  },
  {
    ...
    location: "Hikkaduwa",
    rating: "4.6",
    image: require("../../../../../assets/images/travelModes/motorbike/hikka/bike2.jpg"),
    count: 10,
    path: "fgf",
        priceperhour:100
  },
  {
    ...
    location: "Hikkaduwa",
    rating: "4.9",
    image: require("../../../../../assets/images/travelModes/motorbike/hikka/bike3.jpg"),
    count: 5,
    path: "f",
    priceperhour:100
  },
  {
    ...
    location: "Hikkaduwa",
    rating: "4.9",
    image: require("../../../../../assets/images/travelModes/motorbike/hikka/bike4.jpg"),
    count: 5,
    path: "f",
    priceperhour:100
  },
  {
    ...
    location: "Hikkaduwa",
    rating: "4.9",
    image: require("../../../../../assets/images/travelModes/motorbike/hikka/bike5.jpg"),
    count: 5,
    path: "f",
    priceperhour:100
  },
