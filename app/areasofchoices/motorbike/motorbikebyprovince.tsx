...
export default function Areas() {
  ...
  const tasks = [
    ...
    { id: "5", title: "Jaffna", icon: "motorbike", color: "#3674B5", path: "areasofchoices/motorbike/province/north/jaffnabike" },
    { id: "6", title: "Gampaha", icon: "motorbike", color: "#3674B5", path: "areasofchoices/motorbike/province/central/gampalabike" },
  ];
